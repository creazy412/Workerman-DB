...
{
	/*** mysql hostname ***/
	private $hostname = '120.120.120.120'; // Put your host name here
	/*** mysql username ***/
	private $username = 'mysqlUser'; // Put your MySQL User name here
	/*** mysql password ***/
	private $password = 'passswordPassword'; // Put Your MySQL Password here
	/*** mysql password ***/
	private $dbName = 'balabala'; // Put Your MySQL Database name here
	/*** database resource ***/
